...
;;   in the terminal, which can't distinguish them either, however, when GUIs came about Emacs
;;   greated separate input events for more contentious keys like TAB and RET.
