...
(use-package magit
  ...
  :config
  ;;D;; (add-to-list 'doom-debug-variables 'magit-refresh-verbose)
...
(use-package code-review
  :disabled
  ;; Fixme: [`Given parent class emacsql-sqlite-connection is not a class` on startup from `code-review` · Issue #7191 · doomemacs/doomemacs](https://github.com/doomemacs/doomemacs/issues/7191)
